...
export default function Auth() {
    ...
    const handleOAuthLogin = (provider) => {
      // Assuming standard Spring Boot OAuth2 setup
          ...
          <div className="p-8">
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex justify-center gap-4">
                <button type="button" onClick={() => handleOAuthLogin('google')} className="p-3 border border-gray-200 rounded-full hover:bg-gray-50 transition cursor-pointer">
                ...
                <button type="button" onClick={() => handleOAuthLogin('facebook')} className="p-3 border border-gray-200 rounded-full hover:bg-gray-50 transition cursor-pointer">
                  <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
