...
export default function Contact() {
  return (
    <div className="bg-gray-50 text-gray-800 flex-1 flex flex-col w-full h-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" placeholder="مثلاً: سارة أحمد" className="w-full p-3 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-pink-500 outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-2">رقم الموبايل</label>
                  <input type="tel" placeholder="01XXXXXXXXX" className="w-full p-3 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-pink-500 outline-none" />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <textarea rows={5} placeholder="اكتبي تفاصيل استفسارك هنا..." className="w-full p-3 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-pink-500 outline-none"></textarea>
              </div>
              <button type="button" className="w-full bg-pink-600 text-white py-4 rounded-xl font-bold shadow-lg hover:bg-pink-700 transition transform hover:scale-[1.02]">
                إرسال الرسالة
              </button>
            </form>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl overflow-hidden shadow-md h-64 bg-gray-200">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55251.3770996495!2d31.2234448!3d30.0594838!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583fa60b21beeb%3A0x79dfb296511562b3!2sCairo%2C%20Egypt!5e0!3m2!1sen!2s!4v1640000000000!5m2!1sen!2s" 
