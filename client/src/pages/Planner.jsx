      ...
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden relative min-h-[500px] flex flex-col">
        ...
        <div className="p-8 pb-0">
          <div className="flex justify-between items-center mb-6">
            <Link href="/" className="text-gray-400 hover:text-primary text-sm font-bold">✕ إلغاء ورجوع</Link>
            <span className="text-primary font-bold tracking-widest">زغروطة ✨</span>
          </div>
          <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
            <div className="bg-primary h-full transition-all duration-500 ease-in-out" style={{ width: `${(step / totalSteps) * 100}%` }}></div>
          </div>
        </div>
        ...
        <form className="p-8 flex-1 flex flex-col justify-center">
          ...
          {step === 1 && (<div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input type="date" className="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:border-primary-500 outline-none text-gray-600 font-bold"/>
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">المدينة</label>
                  <select className="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:border-primary-500 outline-none text-gray-600 font-bold cursor-pointer">
          ...
          {step === 2 && (<div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-8">
                <div className="text-center">
                  <span className="text-4xl font-black text-primary">{budget.toLocaleString()}</span>
                  <span className="text-gray-400 font-bold mr-2">ج.م</span>
                </div>
                <input type="range" min="5000" max="200000" step="1000" value={budget} onChange={(e) => setBudget(parseInt(e.target.value))} className="w-full h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-pink-600"/>
                ...
                <div className="bg-primary-50 p-4 rounded-xl border border-primary-100 text-sm text-primary-800 flex gap-3 items-start">
                  <span>💡</span>
          ...
          {step === 3 && (<div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className="cursor-pointer group">
                  ...
                  <div className="border-2 border-gray-100 rounded-2xl p-6 text-center hover:border-primary-200 transition h-full flex flex-col justify-center peer-checked:border-primary peer-checked:bg-primary-50 peer-checked:text-primary">
          ...
          {step === 4 && (<div className="text-center py-10 animate-in fade-in duration-500">
              <div className="w-20 h-20 border-4 border-primary-200 border-t-pink-600 rounded-full animate-spin mx-auto mb-6"></div>
        ...
        {step <= totalSteps && (<div className="p-8 pt-0 flex justify-between items-center">
            <button type="button" onClick={prevStep} className={`text-gray-400 font-bold hover:text-gray-600 ${step === 1 ? 'invisible' : ''}`}>
              رجوع
            </button>
            <button type="button" onClick={nextStep} className="bg-primary text-primary-foreground px-10 py-3 rounded-xl font-bold shadow-lg hover:bg-primary-hover hover:shadow-xl transition transform hover:-translate-y-1">
