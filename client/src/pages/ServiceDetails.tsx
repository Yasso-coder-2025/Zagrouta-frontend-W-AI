    ...
    <>
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3 text-sm text-gray-500 flex items-center gap-2">
          <Link href="/" className="hover:text-pink-600">الرئيسية</Link> <span>/</span>
          <Link href="/services" className="hover:text-pink-600">الخدمات</Link> <span>/</span>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              <div className="h-[400px] overflow-hidden rounded-xl mb-4 relative group">
                <img 
                  src={mainImage} 
                  className={`w-full h-full object-cover transition-opacity duration-300 ${animateImage ? 'opacity-50' : 'opacity-100'}`} 
                  alt="قاعة الماسة" 
                />
                <span className="absolute top-4 right-4 bg-pink-600 text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">قاعة مميزة</span>
              </div>
              <div className="flex gap-4 overflow-x-auto pb-2 hide-scrollbar">
                {images.map((img, idx) => (
                  <img 
                    ...
                    src={img} 
                    className={`w-24 h-24 rounded-lg object-cover cursor-pointer border-2 transition-all duration-200 ${mainImage === img ? 'border-pink-600 opacity-100' : 'border-transparent opacity-70 hover:opacity-100 hover:border-pink-600'}`}
                    alt="Thumbnail" 
                  />
                ))}
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center font-bold text-pink-600">س</div>
                  <div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-pink-100 sticky top-24">
              <div className="flex justify-between items-end mb-6">
                <div>
                  <span className="text-gray-400 text-sm block">سعر الباقة يبدأ من</span>
                  <span className="text-3xl font-black text-pink-600">25,000 ج.م</span>
                </div>
              </div>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input type="date" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 outline-none cursor-pointer" />
                </div>
                
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">عدد المدعوين (تقريبي)</label>
                  <select className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 outline-none cursor-pointer">
                ...
                <Link href="/checkout">
                  <button type="button" className="mt-4 w-full bg-pink-600 text-white py-4 rounded-xl font-bold shadow-md hover:bg-pink-700 hover:shadow-lg transition transform hover:-translate-y-1 flex justify-center items-center gap-2 text-lg">
                    <span>📅</span> احجز الميعاد
                  </button>
                </Link>

                <button type="button" className="w-full bg-white border-2 border-pink-100 text-pink-600 py-3 rounded-xl font-bold hover:bg-pink-50 transition flex justify-center items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/services/10" className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 cursor-pointer hover:shadow-md transition block">
              ...
              <div className="p-4">
                ...
                <p className="text-pink-600 font-bold text-sm">18,000 ج.م</p>
              </div>
            </Link>
            <Link href="/services/11" className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 cursor-pointer hover:shadow-md transition block">
              ...
              <div className="p-4">
                ...
                <p className="text-pink-600 font-bold text-sm">30,000 ج.م</p>
              </div>
            </Link>
            <Link href="/services/12" className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 cursor-pointer hover:shadow-md transition block">
              ...
              <div className="p-4">
                ...
                <p className="text-pink-600 font-bold text-sm">15,000 ج.م</p>
              </div>
            </Link>
          </div>
        </div>
